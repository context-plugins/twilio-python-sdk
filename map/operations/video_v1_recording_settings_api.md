...
Accessor: `client.video_v1_recording_settings_api` · Source: `twilio_sdk/apis/video_v1_recording_settings_api.py` · 2 operations
...
- **Server**: `default6`
- **Signature**: `def create_recording_settings(friendly_name: str, *, aws_credentials_sid: str | None = None, encryption_key_sid: str | None = None, aws_s3_url: AnyUrl | None = None, aws_storage_enabled: bool | None = None, encryption_enabled: bool | None = None, request_options: RequestOptionsOrDict | None = None)`
...
| Type | Source |
| --- | --- |
| `VideoV1RecordingSettings` | `twilio_sdk/models/video_v1_recording_settings.py` |
