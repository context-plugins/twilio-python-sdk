...
Accessor: `client.verify_v2_entity` · Source: `twilio_sdk/apis/verify_v2_entity.py` · 4 operations
...
| Type | Source |
| --- | --- |
| `VerifyV2ServiceEntity` | `twilio_sdk/models/verify_v2_service_entity.py` |
...
| Type | Source |
| --- | --- |
| `ListEntityResponse` | `twilio_sdk/models/list_entity_response.py` |
