...
Accessor: `client.api20100401_shared_cost` · Source: `twilio/apis/api20100401_shared_cost.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `ListAvailablePhoneNumberSharedCostResponse` | `twilio/models/list_available_phone_number_shared_cost_response.py` |
