...
- **Returns (parsed)**: `ListAvailablePhoneNumberSharedCostResponse`
- **Returns (raw)**: `ApiResult[ListAvailablePhoneNumberSharedCostResponse, RawError]`
- **Error**: `RawError` — **Case B**

| Type | Source |
| --- | --- |
| `ListAvailablePhoneNumberSharedCostResponse` | `twilio_sdk/models/list_available_phone_number_shared_cost_response.py` |
