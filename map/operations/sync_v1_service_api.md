...
Accessor: `client.sync_v1_service_api` · Source: `twilio_sdk/apis/sync_v1_service_api.py` · 5 operations
...
- **Server**: `default12`
- **Signature**: `def create_service5(*, friendly_name: str | None = None, webhook_url: AnyUrl | None = None, reachability_webhooks_enabled: bool | None = None, acl_enabled: bool | None = None, reachability_debouncing_enabled: bool | None = None, reachability_debouncing_window: int | None = None, webhooks_from_rest_enabled: bool | None = None, request_options: RequestOptionsOrDict | None = None)`
...
| Type | Source |
| --- | --- |
| `SyncV1Service` | `twilio_sdk/models/sync_v1_service.py` |
...
| Type | Source |
| --- | --- |
| `ListServiceResponse4` | `twilio_sdk/models/list_service_response4.py` |

### client.sync_v1_service_api.update_service4

- **Route**: `POST /v1/Services/{Sid}`
- **Server**: `default12`
- **Signature**: `def update_service4(sid: str, *, webhook_url: AnyUrl | None = None, friendly_name: str | None = None, reachability_webhooks_enabled: bool | None = None, acl_enabled: bool | None = None, reachability_debouncing_enabled: bool | None = None, reachability_debouncing_window: int | None = None, webhooks_from_rest_enabled: bool | None = None, request_options: RequestOptionsOrDict | None = None)`
  - required, positional: `sid`
