...
Accessor: `client.taskrouter_v1_worker_reservation` · Source: `twilio/apis/taskrouter_v1_worker_reservation.py` · 3 operations
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkerWorkerReservation` | `twilio/models/taskrouter_v1_workspace_worker_worker_reservation.py` |
...
| Type | Source |
| --- | --- |
| `WorkerReservationEnumStatusOrStr` | `twilio/models/enums/worker_reservation_enum_status.py` |
| `ListWorkerReservationResponse` | `twilio/models/list_worker_reservation_response.py` |
...
| `WorkerReservationEnumConferenceEventOrStr` | `twilio/models/enums/worker_reservation_enum_conference_event.py` |
| `TaskrouterV1WorkspaceWorkerWorkerReservation` | `twilio/models/taskrouter_v1_workspace_worker_worker_reservation.py` |
