...
- **Server**: `default`
- **Signature**: `def update_member(account_sid: str, queue_sid: str, call_sid: str, url: AnyUrl, *, method: Method2OrStr | None = None, request_options: RequestOptionsOrDict | None = None)`
