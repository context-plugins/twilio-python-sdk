...
Accessor: `client.verify_v2_verification_check` · Source: `twilio/apis/verify_v2_verification_check.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `VerifyV2ServiceVerificationCheck` | `twilio/models/verify_v2_service_verification_check.py` |
