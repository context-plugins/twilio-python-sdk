...
Accessor: `client.verify_v2_notification` · Source: `twilio/apis/verify_v2_notification.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `VerifyV2ServiceEntityChallengeNotification` | `twilio/models/verify_v2_service_entity_challenge_notification.py` |
