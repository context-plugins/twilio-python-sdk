...
Accessor: `client.api20100401_user_defined_message_subscription` · Source: `twilio/apis/api20100401_user_defined_message_subscription.py` · 2 operations
...
| Type | Source |
| --- | --- |
| `Method3OrStr` | `twilio/models/enums/method3.py` |
| `ApiV2010AccountCallUserDefinedMessageSubscription` | `twilio/models/api_v2010_account_call_user_defined_message_subscription.py` |
