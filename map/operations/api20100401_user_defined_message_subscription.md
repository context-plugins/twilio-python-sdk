...
- **Server**: `default`
- **Signature**: `def create_user_defined_message_subscription(account_sid: str, call_sid: str, callback: AnyUrl, *, idempotency_key: str | None = None, method: Method3OrStr | None = None, request_options: RequestOptionsOrDict | None = None)`
