...
Accessor: `client.taskrouter_v1_workflow_cumulative_statistics` · Source: `twilio/apis/taskrouter_v1_workflow_cumulative_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkflowWorkflowCumulativeStatistics` | `twilio/models/taskrouter_v1_workspace_workflow_workflow_cumulative_statistics.py` |
