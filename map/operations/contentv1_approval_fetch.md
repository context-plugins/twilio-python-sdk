...
Accessor: `client.contentv1_approval_fetch` · Source: `twilio/apis/contentv1_approval_fetch.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `ContentV1ContentApprovalFetch` | `twilio/models/content_v1_content_approval_fetch.py` |
