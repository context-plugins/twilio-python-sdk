...
Accessor: `client.flex_v1_insights_segments_api` · Source: `twilio/apis/flex_v1_insights_segments_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `ListInsightsSegmentsResponse` | `twilio/models/list_insights_segments_response.py` |
