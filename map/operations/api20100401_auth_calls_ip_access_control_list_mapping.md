...
- **Returns (parsed)**: `SipAuthCallsIpAccessControlListMapping`
- **Returns (raw)**: `ApiResult[SipAuthCallsIpAccessControlListMapping, RawError]`
...
- **Returns (parsed)**: `ListSipAuthCallsIpAccessControlListMappingResponse`
- **Returns (raw)**: `ApiResult[ListSipAuthCallsIpAccessControlListMappingResponse, RawError]`
- **Error**: `RawError` — **Case B**
