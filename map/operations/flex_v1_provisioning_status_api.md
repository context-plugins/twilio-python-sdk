...
Accessor: `client.flex_v1_provisioning_status_api` · Source: `twilio_sdk/apis/flex_v1_provisioning_status_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `FlexV1ProvisioningStatus` | `twilio_sdk/models/flex_v1_provisioning_status.py` |
