...
Accessor: `client.flex_v1_insights_settings_comment_api` · Source: `twilio/apis/flex_v1_insights_settings_comment_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `FlexV1InsightsSettingsComment` | `twilio/models/flex_v1_insights_settings_comment.py` |
