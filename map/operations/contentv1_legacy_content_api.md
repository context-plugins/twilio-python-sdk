...
Accessor: `client.contentv1_legacy_content_api` · Source: `twilio_sdk/apis/contentv1_legacy_content_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `ListLegacyContentResponse` | `twilio_sdk/models/list_legacy_content_response.py` |
