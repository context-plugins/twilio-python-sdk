...
- **Server**: `default`
- **Signature**: `def update_short_code(account_sid: str, sid: str, *, friendly_name: str | None = None, api_version: str | None = None, sms_url: AnyUrl | None = None, sms_method: SmsMethod14OrStr | None = None, sms_fallback_url: AnyUrl | None = None, sms_fallback_method: SmsFallbackMethod14OrStr | None = None, request_options: RequestOptionsOrDict | None = None)`
  - required, positional: `account_sid`, `sid`
