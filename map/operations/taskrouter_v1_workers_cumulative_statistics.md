...
Accessor: `client.taskrouter_v1_workers_cumulative_statistics` · Source: `twilio/apis/taskrouter_v1_workers_cumulative_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkerWorkersCumulativeStatistics` | `twilio/models/taskrouter_v1_workspace_worker_workers_cumulative_statistics.py` |
