...
Accessor: `client.taskrouter_v1_workspace_statistics` · Source: `twilio/apis/taskrouter_v1_workspace_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkspaceStatistics` | `twilio/models/taskrouter_v1_workspace_workspace_statistics.py` |
