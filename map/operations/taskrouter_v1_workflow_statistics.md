...
Accessor: `client.taskrouter_v1_workflow_statistics` · Source: `twilio/apis/taskrouter_v1_workflow_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkflowWorkflowStatistics` | `twilio/models/taskrouter_v1_workspace_workflow_workflow_statistics.py` |
