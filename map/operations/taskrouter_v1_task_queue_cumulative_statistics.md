...
Accessor: `client.taskrouter_v1_task_queue_cumulative_statistics` · Source: `twilio_sdk/apis/taskrouter_v1_task_queue_cumulative_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceTaskQueueTaskQueueCumulativeStatistics` | `twilio_sdk/models/taskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics.py` |
