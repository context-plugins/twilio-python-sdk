...
Accessor: `client.api20100401_payment` · Source: `twilio/apis/api20100401_payment.py` · 2 operations
...
| Type | Source |
| --- | --- |
| `PaymentsEnumBankAccountTypeOrStr` | `twilio/models/enums/payments_enum_bank_account_type.py` |
| `PaymentsEnumPaymentMethodOrStr` | `twilio/models/enums/payments_enum_payment_method.py` |
| `PaymentsEnumTokenTypeOrStr` | `twilio/models/enums/payments_enum_token_type.py` |
| `ConfirmationOrStr` | `twilio/models/enums/confirmation.py` |
| `ApiV2010AccountCallPayments` | `twilio/models/api_v2010_account_call_payments.py` |
...
| Type | Source |
| --- | --- |
| `PaymentsEnumCaptureOrStr` | `twilio/models/enums/payments_enum_capture.py` |
| `PaymentsEnumStatusOrStr` | `twilio/models/enums/payments_enum_status.py` |
| `ApiV2010AccountCallPayments` | `twilio/models/api_v2010_account_call_payments.py` |
