...
Accessor: `client.messaging_v1_destination_alpha_sender` · Source: `twilio/apis/messaging_v1_destination_alpha_sender.py` · 4 operations
...
| Type | Source |
| --- | --- |
| `MessagingV1ServiceDestinationAlphaSender` | `twilio/models/messaging_v1_service_destination_alpha_sender.py` |
...
| Type | Source |
| --- | --- |
| `ListDestinationAlphaSenderResponse` | `twilio/models/list_destination_alpha_sender_response.py` |
