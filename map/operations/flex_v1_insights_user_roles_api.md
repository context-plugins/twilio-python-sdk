...
Accessor: `client.flex_v1_insights_user_roles_api` · Source: `twilio/apis/flex_v1_insights_user_roles_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `FlexV1InsightsUserRoles` | `twilio/models/flex_v1_insights_user_roles.py` |
