...
- **Returns (parsed)**: `ListAvailablePhoneNumberTollFreeResponse`
- **Returns (raw)**: `ApiResult[ListAvailablePhoneNumberTollFreeResponse, RawError]`
- **Error**: `RawError` — **Case B**

| Type | Source |
| --- | --- |
| `ListAvailablePhoneNumberTollFreeResponse` | `twilio_sdk/models/list_available_phone_number_toll_free_response.py` |
