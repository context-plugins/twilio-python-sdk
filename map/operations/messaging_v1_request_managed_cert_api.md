...
Accessor: `client.messaging_v1_request_managed_cert_api` · Source: `twilio/apis/messaging_v1_request_managed_cert_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `MessagingV1RequestManagedCert` | `twilio/models/messaging_v1_request_managed_cert.py` |
