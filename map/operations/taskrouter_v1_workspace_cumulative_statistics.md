...
Accessor: `client.taskrouter_v1_workspace_cumulative_statistics` · Source: `twilio_sdk/apis/taskrouter_v1_workspace_cumulative_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkspaceCumulativeStatistics` | `twilio_sdk/models/taskrouter_v1_workspace_workspace_cumulative_statistics.py` |
