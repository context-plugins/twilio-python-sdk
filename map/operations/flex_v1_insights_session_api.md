...
Accessor: `client.flex_v1_insights_session_api` · Source: `twilio/apis/flex_v1_insights_session_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `FlexV1InsightsSession` | `twilio/models/flex_v1_insights_session.py` |
