...
Accessor: `client.api20100401_application` · Source: `twilio_sdk/apis/api20100401_application.py` · 5 operations
...
- **Server**: `default`
- **Signature**: `def create_application(account_sid: str, *, api_version: str | None = None, voice_url: AnyUrl | None = None, voice_method: VoiceMethod7OrStr | None = None, voice_fallback_url: AnyUrl | None = None, voice_fallback_method: VoiceFallbackMethod7OrStr | None = None, status_callback: AnyUrl | None = None, status_callback_method: StatusCallbackMethod6OrStr | None = None, voice_caller_id_lookup: bool | None = None, sms_url: AnyUrl | None = None, sms_method: SmsMethod7OrStr | None = None, sms_fallback_url: AnyUrl | None = None, sms_fallback_method: SmsFallbackMethod7OrStr | None = None, sms_status_callback: AnyUrl | None = None, message_status_callback: AnyUrl | None = None, friendly_name: str | None = None, public_application_connect_enabled: bool | None = None, request_options: RequestOptionsOrDict | None = None)`
...
| `StatusCallbackMethod6OrStr` | `twilio_sdk/models/enums/status_callback_method6.py` |
| `SmsMethod7OrStr` | `twilio_sdk/models/enums/sms_method7.py` |
| `SmsFallbackMethod7OrStr` | `twilio_sdk/models/enums/sms_fallback_method7.py` |
| `ApiV2010AccountApplication` | `twilio_sdk/models/api_v2010_account_application.py` |
...
| Type | Source |
| --- | --- |
| `ListApplicationResponse` | `twilio_sdk/models/list_application_response.py` |

### client.api20100401_application.update_application

- **Route**: `POST /2010-04-01/Accounts/{AccountSid}/Applications/{Sid}.json`
- **Server**: `default`
- **Signature**: `def update_application(account_sid: str, sid: str, *, friendly_name: str | None = None, api_version: str | None = None, voice_url: AnyUrl | None = None, voice_method: VoiceMethod7OrStr | None = None, voice_fallback_url: AnyUrl | None = None, voice_fallback_method: VoiceFallbackMethod7OrStr | None = None, status_callback: AnyUrl | None = None, status_callback_method: StatusCallbackMethod6OrStr | None = None, voice_caller_id_lookup: bool | None = None, sms_url: AnyUrl | None = None, sms_method: SmsMethod7OrStr | None = None, sms_fallback_url: AnyUrl | None = None, sms_fallback_method: SmsFallbackMethod7OrStr | None = None, sms_status_callback: AnyUrl | None = None, message_status_callback: AnyUrl | None = None, public_application_connect_enabled: bool | None = None, request_options: RequestOptionsOrDict | None = None)`
  - required, positional: `account_sid`, `sid`
