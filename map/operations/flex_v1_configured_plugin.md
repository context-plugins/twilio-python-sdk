...
Accessor: `client.flex_v1_configured_plugin` · Source: `twilio/apis/flex_v1_configured_plugin.py` · 2 operations
...
| Type | Source |
| --- | --- |
| `FlexV1PluginConfigurationConfiguredPlugin` | `twilio/models/flex_v1_plugin_configuration_configured_plugin.py` |
...
| Type | Source |
| --- | --- |
| `ListConfiguredPluginResponse` | `twilio/models/list_configured_plugin_response.py` |
