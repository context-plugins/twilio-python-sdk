...
Accessor: `client.studio_v2_flow_revision` · Source: `twilio/apis/studio_v2_flow_revision.py` · 2 operations
...
| Type | Source |
| --- | --- |
| `StudioV2FlowFlowRevision` | `twilio/models/studio_v2_flow_flow_revision.py` |
...
| Type | Source |
| --- | --- |
| `ListFlowRevisionResponse` | `twilio/models/list_flow_revision_response.py` |
