...
- **Returns (parsed)**: `ListAvailablePhoneNumberLocalResponse`
- **Returns (raw)**: `ApiResult[ListAvailablePhoneNumberLocalResponse, RawError]`
- **Error**: `RawError` — **Case B**

| Type | Source |
| --- | --- |
| `ListAvailablePhoneNumberLocalResponse` | `twilio_sdk/models/list_available_phone_number_local_response.py` |
