...
Accessor: `client.taskrouter_v1_workflow_real_time_statistics` · Source: `twilio/apis/taskrouter_v1_workflow_real_time_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkflowWorkflowRealTimeStatistics` | `twilio/models/taskrouter_v1_workspace_workflow_workflow_real_time_statistics.py` |
