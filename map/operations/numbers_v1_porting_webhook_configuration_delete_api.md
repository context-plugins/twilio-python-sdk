...
Accessor: `client.numbers_v1_porting_webhook_configuration_delete_api` · Source: `twilio/apis/numbers_v1_porting_webhook_configuration_delete_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `PortingWebhookConfigurationDeleteEnumWebhookTypeOrStr` | `twilio/models/enums/porting_webhook_configuration_delete_enum_webhook_type.py` |
