...
- **Params**: `business_name` — form field `BusinessName` · `business_website` — form field `BusinessWebsite` · `notification_email` — form field `NotificationEmail` · `use_case_categories` — form field `UseCaseCategories` · `use_case_summary` — form field `UseCaseSummary` · `production_message_sample` — form field `ProductionMessageSample` · `opt_in_image_urls` — form field `OptInImageUrls` · `opt_in_type` — form field `OptInType` · `message_volume` — form field `MessageVolume` · `tollfree_phone_number_sid` — form field `TollfreePhoneNumberSid` · `customer_profile_sid` — form field `CustomerProfileSid` · `business_street_address` — form field `BusinessStreetAddress` · `business_street_address2` — form field `BusinessStreetAddress2` · `business_city` — form field `BusinessCity` · `business_state_province_region` — form field `BusinessStateProvinceRegion` · `business_postal_code` — form field `BusinessPostalCode` · `business_country` — form field `BusinessCountry` · `additional_information` — form field `AdditionalInformation` · `business_contact_first_name` — form field `BusinessContactFirstName` · `business_contact_last_name` — form field `BusinessContactLastName` · `business_contact_email` — form field `BusinessContactEmail` · `business_contact_phone` — form field `BusinessContactPhone` · `external_reference_id` — form field `ExternalReferenceId` · `business_registration_number` — form field `BusinessRegistrationNumber` · `business_registration_authority` — form field `BusinessRegistrationAuthority` · `business_registration_country` — form field `BusinessRegistrationCountry` · `business_type` — form field `BusinessType` · `business_registration_phone_number` — form field `BusinessRegistrationPhoneNumber` · `doing_business_as` — form field `DoingBusinessAs` · `opt_in_confirmation_message` — form field `OptInConfirmationMessage` · `help_message_sample` — form field `HelpMessageSample` · `privacy_policy_url` — form field `PrivacyPolicyUrl` · `terms_and_conditions_url` — form field `TermsAndConditionsUrl` · `age_gated_content` — form field `AgeGatedContent` · `opt_in_keywords` — form field `OptInKeywords` · `vetting_provider` — form field `VettingProvider` · `vetting_id` — form field `VettingId`
- **Returns (parsed)**: `MessagingV1TollfreeVerification`
- **Returns (raw)**: `ApiResult[MessagingV1TollfreeVerification, RawError]`
...
- **Returns (parsed)**: `ListTollfreeVerificationResponse`
- **Returns (raw)**: `ApiResult[ListTollfreeVerificationResponse, RawError]`
- **Error**: `RawError` — **Case B**
...
- **Signature**: `def update_tollfree_verification(sid: str, *, business_name: str | None = None, business_website: str | None = None, notification_email: str | None = None, use_case_categories: list[TollfreeVerificationEnumUseCaseCategoryOrStr | None] | None = None, use_case_summary: str | None = None, production_message_sample: str | None = None, opt_in_image_urls: list[str] | None = None, opt_in_type: TollfreeVerificationEnumOptInTypeOrStr | None = None, message_volume: str | None = None, business_street_address: str | None = None, business_street_address2: str | None = None, business_city: str | None = None, business_state_province_region: str | None = None, business_postal_code: str | None = None, business_country: str | None = None, additional_information: str | None = None, business_contact_first_name: str | None = None, business_contact_last_name: str | None = None, business_contact_email: str | None = None, business_contact_phone: str | None = None, edit_reason: str | None = None, business_registration_number: str | None = None, business_registration_authority: TollfreeVerificationEnumBusinessRegistrationAuthorityOrStr | None = None, business_registration_country: str | None = None, business_type: TollfreeVerificationEnumBusinessTypeOrStr | None = None, business_registration_phone_number: str | None = None, doing_business_as: str | None = None, opt_in_confirmation_message: str | None = None, help_message_sample: str | None = None, privacy_policy_url: str | None = None, terms_and_conditions_url: str | None = None, age_gated_content: bool | None = None, opt_in_keywords: list[str] | None = None, vetting_provider: TollfreeVerificationEnumVettingProviderOrStr | None = None, vetting_id: str | None = None, request_options: RequestOptionsOrDict | None = None)`
  - required, positional: `sid`
- **Params**: `sid` — path `Sid` · `business_name` — form field `BusinessName` · `business_website` — form field `BusinessWebsite` · `notification_email` — form field `NotificationEmail` · `use_case_categories` — form field `UseCaseCategories` · `use_case_summary` — form field `UseCaseSummary` · `production_message_sample` — form field `ProductionMessageSample` · `opt_in_image_urls` — form field `OptInImageUrls` · `opt_in_type` — form field `OptInType` · `message_volume` — form field `MessageVolume` · `business_street_address` — form field `BusinessStreetAddress` · `business_street_address2` — form field `BusinessStreetAddress2` · `business_city` — form field `BusinessCity` · `business_state_province_region` — form field `BusinessStateProvinceRegion` · `business_postal_code` — form field `BusinessPostalCode` · `business_country` — form field `BusinessCountry` · `additional_information` — form field `AdditionalInformation` · `business_contact_first_name` — form field `BusinessContactFirstName` · `business_contact_last_name` — form field `BusinessContactLastName` · `business_contact_email` — form field `BusinessContactEmail` · `business_contact_phone` — form field `BusinessContactPhone` · `edit_reason` — form field `EditReason` · `business_registration_number` — form field `BusinessRegistrationNumber` · `business_registration_authority` — form field `BusinessRegistrationAuthority` · `business_registration_country` — form field `BusinessRegistrationCountry` · `business_type` — form field `BusinessType` · `business_registration_phone_number` — form field `BusinessRegistrationPhoneNumber` · `doing_business_as` — form field `DoingBusinessAs` · `opt_in_confirmation_message` — form field `OptInConfirmationMessage` · `help_message_sample` — form field `HelpMessageSample` · `privacy_policy_url` — form field `PrivacyPolicyUrl` · `terms_and_conditions_url` — form field `TermsAndConditionsUrl` · `age_gated_content` — form field `AgeGatedContent` · `opt_in_keywords` — form field `OptInKeywords` · `vetting_provider` — form field `VettingProvider` · `vetting_id` — form field `VettingId`
- **Returns (parsed)**: `MessagingV1TollfreeVerification`
- **Returns (raw)**: `ApiResult[MessagingV1TollfreeVerification, RawError]`
- **Error**: `RawError` — **Case B**
