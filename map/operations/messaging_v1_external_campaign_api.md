...
Accessor: `client.messaging_v1_external_campaign_api` · Source: `twilio_sdk/apis/messaging_v1_external_campaign_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `MessagingV1ExternalCampaign` | `twilio_sdk/models/messaging_v1_external_campaign.py` |
