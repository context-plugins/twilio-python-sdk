...
Accessor: `client.taskrouter_v1_worker_statistics` · Source: `twilio/apis/taskrouter_v1_worker_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkerWorkerInstanceStatistics` | `twilio/models/taskrouter_v1_workspace_worker_worker_instance_statistics.py` |
