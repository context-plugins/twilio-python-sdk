...
Accessor: `client.api20100401_feedback` · Source: `twilio/apis/api20100401_feedback.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `MessageFeedbackEnumOutcomeOrStr` | `twilio/models/enums/message_feedback_enum_outcome.py` |
| `ApiV2010AccountMessageMessageFeedback` | `twilio/models/api_v2010_account_message_message_feedback.py` |
