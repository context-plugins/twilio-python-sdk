...
Accessor: `client.api20100401_user_defined_message` · Source: `twilio_sdk/apis/api20100401_user_defined_message.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `ApiV2010AccountCallUserDefinedMessage` | `twilio_sdk/models/api_v2010_account_call_user_defined_message.py` |
