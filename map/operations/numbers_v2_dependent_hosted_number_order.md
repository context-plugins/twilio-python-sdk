...
Accessor: `client.numbers_v2_dependent_hosted_number_order` · Source: `twilio/apis/numbers_v2_dependent_hosted_number_order.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `DependentHostedNumberOrderEnumStatusOrStr` | `twilio/models/enums/dependent_hosted_number_order_enum_status.py` |
| `ListDependentHostedNumberOrderResponse` | `twilio/models/list_dependent_hosted_number_order_response.py` |
