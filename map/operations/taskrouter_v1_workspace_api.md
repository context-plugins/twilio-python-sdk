...
- **Server**: `default8`
- **Signature**: `def create_workspace(friendly_name: str, *, event_callback_url: AnyUrl | None = None, events_filter: str | None = None, multi_task_enabled: bool | None = None, template: str | None = None, prioritize_queue_order: WorkspaceEnumQueueOrderOrStr | None = None, request_options: RequestOptionsOrDict | None = None)`
...
- **Server**: `default8`
- **Signature**: `def update_workspace(sid: str, *, default_activity_sid: str | None = None, event_callback_url: AnyUrl | None = None, events_filter: str | None = None, friendly_name: str | None = None, multi_task_enabled: bool | None = None, timeout_activity_sid: str | None = None, prioritize_queue_order: WorkspaceEnumQueueOrderOrStr | None = None, request_options: RequestOptionsOrDict | None = None)`
  - required, positional: `sid`
