...
Accessor: `client.taskrouter_v1_workspace_api` · Source: `twilio/apis/taskrouter_v1_workspace_api.py` · 5 operations
...
| Type | Source |
| --- | --- |
| `WorkspaceEnumQueueOrderOrStr` | `twilio/models/enums/workspace_enum_queue_order.py` |
| `TaskrouterV1Workspace` | `twilio/models/taskrouter_v1_workspace.py` |
...
| Type | Source |
| --- | --- |
| `ListWorkspaceResponse` | `twilio/models/list_workspace_response.py` |
