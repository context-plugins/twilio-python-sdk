...
Accessor: `client.flex_v1_channel_api` · Source: `twilio_sdk/apis/flex_v1_channel_api.py` · 4 operations
...
| Type | Source |
| --- | --- |
| `FlexV1Channel` | `twilio_sdk/models/flex_v1_channel.py` |
...
| Type | Source |
| --- | --- |
| `ListChannelResponse` | `twilio_sdk/models/list_channel_response.py` |
