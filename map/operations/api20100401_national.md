...
- **Returns (parsed)**: `ListAvailablePhoneNumberNationalResponse`
- **Returns (raw)**: `ApiResult[ListAvailablePhoneNumberNationalResponse, RawError]`
- **Error**: `RawError` — **Case B**

| Type | Source |
| --- | --- |
| `ListAvailablePhoneNumberNationalResponse` | `twilio_sdk/models/list_available_phone_number_national_response.py` |
