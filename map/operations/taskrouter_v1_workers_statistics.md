...
Accessor: `client.taskrouter_v1_workers_statistics` · Source: `twilio_sdk/apis/taskrouter_v1_workers_statistics.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TaskrouterV1WorkspaceWorkerWorkerStatistics` | `twilio_sdk/models/taskrouter_v1_workspace_worker_worker_statistics.py` |
