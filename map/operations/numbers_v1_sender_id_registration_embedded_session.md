...
Accessor: `client.numbers_v1_sender_id_registration_embedded_session` · Source: `twilio_sdk/apis/numbers_v1_sender_id_registration_embedded_session.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `NumbersV1CreateEmbeddedSessionRequest` | `twilio_sdk/models/numbers_v1_create_embedded_session_request.py` |
| `NumbersV1CreateEmbeddedSessionRequestDict` | `twilio_sdk/models/numbers_v1_create_embedded_session_request.py` |
| `NumbersV1CreateEmbeddedSessionResponse` | `twilio_sdk/models/numbers_v1_create_embedded_session_response.py` |
| `CreateSenderIdRegistrationEmbeddedSessionErrorBody` | `twilio_sdk/errors/create_sender_id_registration_embedded_session_error.py` |
