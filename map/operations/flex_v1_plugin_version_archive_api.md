...
Accessor: `client.flex_v1_plugin_version_archive_api` · Source: `twilio_sdk/apis/flex_v1_plugin_version_archive_api.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `FlexV1PluginVersionArchive` | `twilio_sdk/models/flex_v1_plugin_version_archive.py` |
