...
Accessor: `client.video_v1_composition_settings_api` · Source: `twilio/apis/video_v1_composition_settings_api.py` · 2 operations
...
- **Server**: `default6`
- **Signature**: `def create_composition_settings(friendly_name: str, *, aws_credentials_sid: str | None = None, encryption_key_sid: str | None = None, aws_s3_url: str | None = None, aws_storage_enabled: bool | None = None, encryption_enabled: bool | None = None, request_options: RequestOptionsOrDict | None = None)`
...
| Type | Source |
| --- | --- |
| `VideoV1CompositionSettings` | `twilio/models/video_v1_composition_settings.py` |
