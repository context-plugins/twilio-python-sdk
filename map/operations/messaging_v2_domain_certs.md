...
Accessor: `client.messaging_v2_domain_certs` · Source: `twilio/apis/messaging_v2_domain_certs.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `MessagingV2DomainCertV4` | `twilio/models/messaging_v2_domain_cert_v4.py` |
