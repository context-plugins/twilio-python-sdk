...
class ListMediaResponse(SdkBaseModel):
    ...
    media_list: Optional[list[ApiV2010AccountMessageMedia]] = UNSET


class ListMediaResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    media_list: NotRequired[list[ApiV2010AccountMessageMedia | ApiV2010AccountMessageMediaDict]]
