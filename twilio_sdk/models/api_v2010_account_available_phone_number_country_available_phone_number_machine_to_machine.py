...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine(SdkBaseModel):
...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachineDict(TypedDict):
