...
from .enums.incoming_phone_number_local_enum_address_requirement import (
    IncomingPhoneNumberLocalEnumAddressRequirementOrStr,
)
from .enums.incoming_phone_number_local_enum_emergency_address_status import (
    IncomingPhoneNumberLocalEnumEmergencyAddressStatusOrStr,
)
from .enums.incoming_phone_number_local_enum_emergency_status import IncomingPhoneNumberLocalEnumEmergencyStatusOrStr
from .enums.incoming_phone_number_local_enum_voice_receive_mode import IncomingPhoneNumberLocalEnumVoiceReceiveModeOrStr
...
class ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal(SdkBaseModel):
    ...
    address_requirements: Optional[IncomingPhoneNumberLocalEnumAddressRequirementOrStr] = UNSET
    ...
    voice_receive_mode: Optional[IncomingPhoneNumberLocalEnumVoiceReceiveModeOrStr] = UNSET
    ...
    """The URL we call when this phone number receives a call. The ``voice_url`` will not be used if a
    ``voice_application_sid`` or a ``trunk_sid`` is set."""

    emergency_status: Optional[IncomingPhoneNumberLocalEnumEmergencyStatusOrStr] = UNSET
    ...
    emergency_address_status: Optional[IncomingPhoneNumberLocalEnumEmergencyAddressStatusOrStr] = UNSET
...
class ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalDict(TypedDict):
    account_sid: NotRequired[str | None]
    address_sid: NotRequired[str | None]
    address_requirements: NotRequired[IncomingPhoneNumberLocalEnumAddressRequirementOrStr]
    ...
    voice_receive_mode: NotRequired[IncomingPhoneNumberLocalEnumVoiceReceiveModeOrStr]
    ...
    voice_fallback_url: NotRequired[str | None]
    voice_method: NotRequired[VoiceMethodOrStr | None]
    voice_url: NotRequired[str | None]
    emergency_status: NotRequired[IncomingPhoneNumberLocalEnumEmergencyStatusOrStr]
    emergency_address_sid: NotRequired[str | None]
    emergency_address_status: NotRequired[IncomingPhoneNumberLocalEnumEmergencyAddressStatusOrStr]
