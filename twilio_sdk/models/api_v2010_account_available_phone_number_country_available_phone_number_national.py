...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational(SdkBaseModel):
...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalDict(TypedDict):
