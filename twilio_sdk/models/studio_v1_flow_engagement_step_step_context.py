...
class StudioV1FlowEngagementStepStepContext(SdkBaseModel):
    account_sid: OptionalNullable[str] = UNSET
    """The SID of the `Account <https://www.twilio.com/docs/iam/api/account>`__ that created the StepContext
    resource."""
...
class StudioV1FlowEngagementStepStepContextDict(TypedDict):
