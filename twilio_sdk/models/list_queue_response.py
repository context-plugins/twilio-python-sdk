...
class ListQueueResponse(SdkBaseModel):
    ...
    queues: Optional[list[ApiV2010AccountQueue]] = UNSET


class ListQueueResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    queues: NotRequired[list[ApiV2010AccountQueue | ApiV2010AccountQueueDict]]
