...
class ListNotificationResponse(SdkBaseModel):
    ...
    notifications: Optional[list[ApiV2010AccountNotification]] = UNSET


class ListNotificationResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    notifications: NotRequired[list[ApiV2010AccountNotification | ApiV2010AccountNotificationDict]]
