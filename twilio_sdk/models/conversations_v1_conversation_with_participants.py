...
from .enums.conversation_with_participants_enum_state import ConversationWithParticipantsEnumStateOrStr


class ConversationsV1ConversationWithParticipants(SdkBaseModel):
    ...
    state: Optional[ConversationWithParticipantsEnumStateOrStr] = UNSET
...
class ConversationsV1ConversationWithParticipantsDict(TypedDict):
    ...
    state: NotRequired[ConversationWithParticipantsEnumStateOrStr]
