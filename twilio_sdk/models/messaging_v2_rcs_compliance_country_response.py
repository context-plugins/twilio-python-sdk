...
class MessagingV2RcsComplianceCountryResponse(SdkBaseModel):
    country: str
    ...
    carriers: Optional[list[MessagingV2RcsCarrier]] = UNSET


class MessagingV2RcsComplianceCountryResponseDict(TypedDict):
    country: str
    registration_sid: NotRequired[str]
    status: NotRequired[MessagingV2RcsCountryStatusOrStr]
    carriers: NotRequired[list[MessagingV2RcsCarrier | MessagingV2RcsCarrierDict]]
