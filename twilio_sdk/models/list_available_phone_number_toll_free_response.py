...
class ListAvailablePhoneNumberTollFreeResponse(SdkBaseModel):
    ...
    available_phone_numbers: Optional[
        list[ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree]
    ] = UNSET


class ListAvailablePhoneNumberTollFreeResponseDict(TypedDict):
    end: NotRequired[int]
