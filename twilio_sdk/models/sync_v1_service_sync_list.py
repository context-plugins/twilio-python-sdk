...
class SyncV1ServiceSyncList(SdkBaseModel):
    ...
    """The SID of the `Account <https://www.twilio.com/docs/iam/api/account>`__ that created the Sync List resource."""
    ...
    """The date and time in GMT when the Sync List expires and will be deleted, specified in `ISO 8601
    <https://en.wikipedia.org/wiki/ISO_8601>`__ format. If the Sync List does not expire, this value is ``null``. The
    ...
    """The identity of the Sync List's creator. If the Sync List is created from the client SDK, the value matches the
    Access Token's ``identity`` field. If the Sync List was created from the REST API, the value is ``system``."""


class SyncV1ServiceSyncListDict(TypedDict):
