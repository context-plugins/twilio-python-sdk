...
class ListConnectAppResponse(SdkBaseModel):
    ...
    connect_apps: Optional[list[ApiV2010AccountConnectApp]] = UNSET


class ListConnectAppResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    connect_apps: NotRequired[list[ApiV2010AccountConnectApp | ApiV2010AccountConnectAppDict]]
