...
class TaskrouterV1WorkspaceWorkflow(SdkBaseModel):
    ...
    assignment_callback_url: OptionalNullable[AnyUrl] = UNSET
    ...
    fallback_assignment_callback_url: OptionalNullable[AnyUrl] = UNSET
...
class TaskrouterV1WorkspaceWorkflowDict(TypedDict):
    ...
    assignment_callback_url: NotRequired[AnyUrl | None]
    configuration: NotRequired[str | None]
    date_created: NotRequired[RFC3339DateTime | None]
    date_updated: NotRequired[RFC3339DateTime | None]
    document_content_type: NotRequired[str | None]
    fallback_assignment_callback_url: NotRequired[AnyUrl | None]
