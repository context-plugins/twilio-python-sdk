...
class IncomingPhoneNumberEnumEmergencyAddressStatus(str, Enum):
...
IncomingPhoneNumberEnumEmergencyAddressStatusOrStr: TypeAlias = Annotated[
    IncomingPhoneNumberEnumEmergencyAddressStatus | str,
    open_enum_validator(IncomingPhoneNumberEnumEmergencyAddressStatus),
]
