...
class IncomingPhoneNumberLocalEnumEmergencyAddressStatus(str, Enum):
...
IncomingPhoneNumberLocalEnumEmergencyAddressStatusOrStr: TypeAlias = Annotated[
    IncomingPhoneNumberLocalEnumEmergencyAddressStatus | str,
    open_enum_validator(IncomingPhoneNumberLocalEnumEmergencyAddressStatus),
]
