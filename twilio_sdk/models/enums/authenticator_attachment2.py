...
class AuthenticatorAttachment2(str, Enum):
...
AuthenticatorAttachment2OrStr: TypeAlias = Annotated[
    AuthenticatorAttachment2 | str, open_enum_validator(AuthenticatorAttachment2)
]
