...
class ConferenceRecordingEnumStatus(str, Enum):
...
ConferenceRecordingEnumStatusOrStr: TypeAlias = Annotated[
    ConferenceRecordingEnumStatus | str, open_enum_validator(ConferenceRecordingEnumStatus)
]
