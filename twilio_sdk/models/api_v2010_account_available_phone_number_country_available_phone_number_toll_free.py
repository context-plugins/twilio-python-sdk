...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree(SdkBaseModel):
...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFreeDict(TypedDict):
