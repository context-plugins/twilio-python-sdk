...
class ListAvailablePhoneNumberSharedCostResponse(SdkBaseModel):
    ...
    available_phone_numbers: Optional[
        list[ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost]
    ] = UNSET


class ListAvailablePhoneNumberSharedCostResponseDict(TypedDict):
    end: NotRequired[int]
