...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip(SdkBaseModel):
...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoipDict(TypedDict):
