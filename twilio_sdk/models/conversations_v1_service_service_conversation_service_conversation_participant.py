...
class ConversationsV1ServiceServiceConversationServiceConversationParticipant(SdkBaseModel):
    ...
    participant is using the `Conversation SDK <https://www.twilio.com/docs/conversations/sdk-overview>`__ to
...
class ConversationsV1ServiceServiceConversationServiceConversationParticipantDict(TypedDict):
