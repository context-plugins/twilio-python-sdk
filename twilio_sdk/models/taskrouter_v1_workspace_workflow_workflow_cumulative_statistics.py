...
class TaskrouterV1WorkspaceWorkflowWorkflowCumulativeStatistics(SdkBaseModel):
...
class TaskrouterV1WorkspaceWorkflowWorkflowCumulativeStatisticsDict(TypedDict):
