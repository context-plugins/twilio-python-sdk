...
class ListDependentPhoneNumberResponse(SdkBaseModel):
    ...
    dependent_phone_numbers: Optional[list[ApiV2010AccountAddressDependentPhoneNumber]] = UNSET


class ListDependentPhoneNumberResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    dependent_phone_numbers: NotRequired[
        list[ApiV2010AccountAddressDependentPhoneNumber | ApiV2010AccountAddressDependentPhoneNumberDict]
    ]
