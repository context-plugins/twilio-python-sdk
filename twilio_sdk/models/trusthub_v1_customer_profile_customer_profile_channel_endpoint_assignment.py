...
class TrusthubV1CustomerProfileCustomerProfileChannelEndpointAssignment(SdkBaseModel):
...
class TrusthubV1CustomerProfileCustomerProfileChannelEndpointAssignmentDict(TypedDict):
