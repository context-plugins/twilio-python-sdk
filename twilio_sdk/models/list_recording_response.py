...
class ListRecordingResponse(SdkBaseModel):
    ...
    recordings: Optional[list[ApiV2010AccountRecording]] = UNSET


class ListRecordingResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    recordings: NotRequired[list[ApiV2010AccountRecording | ApiV2010AccountRecordingDict]]
