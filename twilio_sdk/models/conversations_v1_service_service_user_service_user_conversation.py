...
from .enums.service_user_conversation_enum_notification_level import ServiceUserConversationEnumNotificationLevelOrStr
from .enums.service_user_conversation_enum_state import ServiceUserConversationEnumStateOrStr


class ConversationsV1ServiceServiceUserServiceUserConversation(SdkBaseModel):
    ...
    conversation_state: Optional[ServiceUserConversationEnumStateOrStr] = UNSET
    ...
    notification_level: Optional[ServiceUserConversationEnumNotificationLevelOrStr] = UNSET
...
class ConversationsV1ServiceServiceUserServiceUserConversationDict(TypedDict):
    ...
    conversation_state: NotRequired[ServiceUserConversationEnumStateOrStr]
    timers: NotRequired[Any | None]
    attributes: NotRequired[str | None]
    date_created: NotRequired[RFC3339DateTime | None]
    date_updated: NotRequired[RFC3339DateTime | None]
    created_by: NotRequired[str | None]
    notification_level: NotRequired[ServiceUserConversationEnumNotificationLevelOrStr]
