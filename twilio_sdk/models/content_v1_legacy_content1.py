...
class ContentV1LegacyContent1(SdkBaseModel):
    ...
    """The `Content types <https://www.twilio.com/docs/content/content-types-overview>`__ (e.g. twilio/text) for this
    Content resource."""
...
class ContentV1LegacyContent1Dict(TypedDict):
