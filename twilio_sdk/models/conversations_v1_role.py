...
from .enums.role_enum_role_type import RoleEnumRoleTypeOrStr


class ConversationsV1Role(SdkBaseModel):
    ...
    type_: Optional[RoleEnumRoleTypeOrStr] = Field(default=UNSET, alias="type")
...
class ConversationsV1RoleDict(TypedDict):
    sid: NotRequired[str | None]
    account_sid: NotRequired[str | None]
    chat_service_sid: NotRequired[str | None]
    friendly_name: NotRequired[str | None]
    type_: NotRequired[RoleEnumRoleTypeOrStr]
