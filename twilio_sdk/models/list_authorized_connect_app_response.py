...
class ListAuthorizedConnectAppResponse(SdkBaseModel):
    ...
    authorized_connect_apps: Optional[list[ApiV2010AccountAuthorizedConnectApp]] = UNSET


class ListAuthorizedConnectAppResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    authorized_connect_apps: NotRequired[
        list[ApiV2010AccountAuthorizedConnectApp | ApiV2010AccountAuthorizedConnectAppDict]
    ]
