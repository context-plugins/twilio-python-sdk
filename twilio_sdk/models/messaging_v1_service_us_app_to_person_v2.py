...
class MessagingV1ServiceUsAppToPersonV2(SdkBaseModel):
    ...
    privacy_policy_url: AnyUrl | None
    """The URL of the privacy policy for the campaign."""

    terms_and_conditions_url: AnyUrl | None
    """The URL of the terms and conditions for the campaign."""


class MessagingV1ServiceUsAppToPersonV2Dict(TypedDict):
