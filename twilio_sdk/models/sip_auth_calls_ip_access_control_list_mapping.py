...
class SipAuthCallsIpAccessControlListMapping(SdkBaseModel):
    account_sid: OptionalNullable[str] = UNSET
    """The SID of the `Account <https://www.twilio.com/docs/iam/api/account>`__ that created the
...
class SipAuthCallsIpAccessControlListMappingDict(TypedDict):
