...
class ListUsageRecordMonthlyResponse(SdkBaseModel):
    ...
    usage_records: Optional[list[ApiV2010AccountUsageUsageRecordUsageRecordMonthly]] = UNSET


class ListUsageRecordMonthlyResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    usage_records: NotRequired[
        list[ApiV2010AccountUsageUsageRecordUsageRecordMonthly | ApiV2010AccountUsageUsageRecordUsageRecordMonthlyDict]
    ]
