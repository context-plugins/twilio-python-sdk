...
class ApiV2010AccountApplication(SdkBaseModel):
    ...
    message_status_callback: OptionalNullable[str] = UNSET
    ...
    sms_status_callback: OptionalNullable[str] = UNSET
...
class ApiV2010AccountApplicationDict(TypedDict):
    ...
    message_status_callback: NotRequired[str | None]
    ...
    sms_status_callback: NotRequired[str | None]
