...
class ConversationsV2SendContent(SdkBaseModel):
    ...
    media_urls: Optional[list[AnyUrl]] = Field(default=UNSET, alias="mediaUrls")
    """URLs of media attachments to include with the message."""


class ConversationsV2SendContentDict(TypedDict):
    text: NotRequired[str]
    content_id: NotRequired[str]
    variables: NotRequired[dict[str, str]]
    media_urls: NotRequired[list[AnyUrl]]
