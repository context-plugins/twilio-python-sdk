...
class ListAccountResponse(SdkBaseModel):
    ...
    accounts: Optional[list[ApiV2010Account]] = UNSET


class ListAccountResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    accounts: NotRequired[list[ApiV2010Account | ApiV2010AccountDict]]
