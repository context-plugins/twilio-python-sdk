...
class ListUsageRecordTodayResponse(SdkBaseModel):
    ...
    usage_records: Optional[list[ApiV2010AccountUsageUsageRecordUsageRecordToday]] = UNSET


class ListUsageRecordTodayResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    usage_records: NotRequired[
        list[ApiV2010AccountUsageUsageRecordUsageRecordToday | ApiV2010AccountUsageUsageRecordUsageRecordTodayDict]
    ]
