...
class MessagingV1ServiceShortCode(SdkBaseModel):
    sid: OptionalNullable[str] = UNSET
    """The unique string that we created to identify the ShortCode resource."""

    account_sid: OptionalNullable[str] = UNSET
    """The SID of the `Account <https://www.twilio.com/docs/iam/api/account>`__ that created the ShortCode resource."""
    ...
    """The `E.164 <https://www.twilio.com/docs/glossary/what-e164>`__ format of the short code."""
    ...
    """An array of values that describe whether the number can receive calls or messages. Can be: ``SMS`` and
    ``MMS``."""
...
class MessagingV1ServiceShortCodeDict(TypedDict):
