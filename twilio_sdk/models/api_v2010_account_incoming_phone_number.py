...
from .enums.incoming_phone_number_enum_address_requirement import IncomingPhoneNumberEnumAddressRequirementOrStr
from .enums.incoming_phone_number_enum_emergency_address_status import (
    IncomingPhoneNumberEnumEmergencyAddressStatusOrStr,
)
from .enums.incoming_phone_number_enum_emergency_status import IncomingPhoneNumberEnumEmergencyStatusOrStr
from .enums.incoming_phone_number_enum_voice_receive_mode import IncomingPhoneNumberEnumVoiceReceiveModeOrStr
...
class ApiV2010AccountIncomingPhoneNumber(SdkBaseModel):
    account_sid: OptionalNullable[str] = UNSET
    """The SID of the `Account <https://www.twilio.com/docs/iam/api/account>`__ that created this IncomingPhoneNumber
    resource."""

    address_sid: OptionalNullable[str] = UNSET
    """The SID of the Address resource associated with the phone number."""

    address_requirements: Optional[IncomingPhoneNumberEnumAddressRequirementOrStr] = UNSET
    ...
    voice_receive_mode: Optional[IncomingPhoneNumberEnumVoiceReceiveModeOrStr] = UNSET
    ...
    emergency_status: Optional[IncomingPhoneNumberEnumEmergencyStatusOrStr] = UNSET
    ...
    emergency_address_status: Optional[IncomingPhoneNumberEnumEmergencyAddressStatusOrStr] = UNSET
...
class ApiV2010AccountIncomingPhoneNumberDict(TypedDict):
    account_sid: NotRequired[str | None]
    address_sid: NotRequired[str | None]
    address_requirements: NotRequired[IncomingPhoneNumberEnumAddressRequirementOrStr]
    ...
    voice_receive_mode: NotRequired[IncomingPhoneNumberEnumVoiceReceiveModeOrStr]
    ...
    emergency_status: NotRequired[IncomingPhoneNumberEnumEmergencyStatusOrStr]
    emergency_address_sid: NotRequired[str | None]
    emergency_address_status: NotRequired[IncomingPhoneNumberEnumEmergencyAddressStatusOrStr]
