...
from .enums.service_participant_conversation_enum_state import ServiceParticipantConversationEnumStateOrStr


class ConversationsV1ServiceServiceParticipantConversation(SdkBaseModel):
    ...
    conversation_state: Optional[ServiceParticipantConversationEnumStateOrStr] = UNSET
...
class ConversationsV1ServiceServiceParticipantConversationDict(TypedDict):
    ...
    conversation_state: NotRequired[ServiceParticipantConversationEnumStateOrStr]
