...
class ApiV2010AccountConnectApp(SdkBaseModel):
    ...
    authorize_redirect_url: OptionalNullable[AnyUrl] = UNSET
    ...
    deauthorize_callback_url: OptionalNullable[AnyUrl] = UNSET
    ...
    homepage_url: OptionalNullable[AnyUrl] = UNSET
...
class ApiV2010AccountConnectAppDict(TypedDict):
    ...
    authorize_redirect_url: NotRequired[AnyUrl | None]
    company_name: NotRequired[str | None]
    deauthorize_callback_method: NotRequired[DeauthorizeCallbackMethodOrStr | None]
    deauthorize_callback_url: NotRequired[AnyUrl | None]
    description: NotRequired[str | None]
    friendly_name: NotRequired[str | None]
    homepage_url: NotRequired[AnyUrl | None]
