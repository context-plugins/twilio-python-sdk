...
class ListAvailablePhoneNumberNationalResponse(SdkBaseModel):
    ...
    available_phone_numbers: Optional[
        list[ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational]
    ] = UNSET


class ListAvailablePhoneNumberNationalResponseDict(TypedDict):
    end: NotRequired[int]
