...
class ListIncomingPhoneNumberResponse(SdkBaseModel):
    ...
    incoming_phone_numbers: Optional[list[ApiV2010AccountIncomingPhoneNumber]] = UNSET


class ListIncomingPhoneNumberResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    incoming_phone_numbers: NotRequired[
        list[ApiV2010AccountIncomingPhoneNumber | ApiV2010AccountIncomingPhoneNumberDict]
    ]
