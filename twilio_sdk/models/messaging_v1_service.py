...
class MessagingV1Service(SdkBaseModel):
    ...
    inbound_request_url: OptionalNullable[AnyUrl] = UNSET
    ...
    fallback_url: OptionalNullable[AnyUrl] = UNSET
...
class MessagingV1ServiceDict(TypedDict):
    ...
    inbound_request_url: NotRequired[AnyUrl | None]
    inbound_method: NotRequired[AmdStatusCallbackMethodOrStr | None]
    fallback_url: NotRequired[AnyUrl | None]
