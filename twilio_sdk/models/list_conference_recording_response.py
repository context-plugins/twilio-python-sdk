...
class ListConferenceRecordingResponse(SdkBaseModel):
    ...
    recordings: Optional[list[ApiV2010AccountConferenceConferenceRecording]] = UNSET


class ListConferenceRecordingResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    recordings: NotRequired[
        list[ApiV2010AccountConferenceConferenceRecording | ApiV2010AccountConferenceConferenceRecordingDict]
    ]
