...
from .enums.service_conversation_with_participants_enum_state import ServiceConversationWithParticipantsEnumStateOrStr


class ConversationsV1ServiceServiceConversationWithParticipants(SdkBaseModel):
    ...
    state: Optional[ServiceConversationWithParticipantsEnumStateOrStr] = UNSET
...
class ConversationsV1ServiceServiceConversationWithParticipantsDict(TypedDict):
    ...
    state: NotRequired[ServiceConversationWithParticipantsEnumStateOrStr]
