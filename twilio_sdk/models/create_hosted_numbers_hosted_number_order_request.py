...
class CreateHostedNumbersHostedNumberOrderRequest(SdkBaseModel):
    ...
    sms_url: Optional[str] = Field(default=UNSET, alias="smsUrl")
    ...
    sms_fallback_url: Optional[str] = Field(default=UNSET, alias="smsFallbackUrl")
    ...
    status_callback_url: Optional[str] = Field(default=UNSET, alias="statusCallbackUrl")
...
class CreateHostedNumbersHostedNumberOrderRequestDict(TypedDict):
    ...
    sms_url: NotRequired[str]
    sms_method: NotRequired[AmdStatusCallbackMethodOrStr]
    sms_fallback_url: NotRequired[str]
