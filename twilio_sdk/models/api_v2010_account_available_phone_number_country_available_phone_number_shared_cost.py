...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost(SdkBaseModel):
...
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostDict(TypedDict):
