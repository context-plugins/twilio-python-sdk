...
from .enums.execution_enum_status import ExecutionEnumStatusOrStr


class StudioV1FlowExecution(SdkBaseModel):
    ...
    status: Optional[ExecutionEnumStatusOrStr] = UNSET
...
class StudioV1FlowExecutionDict(TypedDict):
    ...
    status: NotRequired[ExecutionEnumStatusOrStr]
