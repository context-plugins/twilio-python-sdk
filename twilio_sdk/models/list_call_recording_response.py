...
class ListCallRecordingResponse(SdkBaseModel):
    ...
    recordings: Optional[list[ApiV2010AccountCallCallRecording]] = UNSET


class ListCallRecordingResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    recordings: NotRequired[list[ApiV2010AccountCallCallRecording | ApiV2010AccountCallCallRecordingDict]]
