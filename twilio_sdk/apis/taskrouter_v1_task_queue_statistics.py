...
from ..models.taskrouter_v1_workspace_task_queue_task_queue_statistics import (
    TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics,
)
from ..server.server import Server


class TaskrouterV1TaskQueueStatistics:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = TaskrouterV1TaskQueueStatisticsWithRawResponse(client, server, auth)
    ...
    def fetch_task_queue_statistics(
        ...
        *,
        ...
        Args:
            ...
            task_channel: Only calculate real-time and cumulative statistics for the specified TaskChannel. Can be the
        ...
        return self._with_raw_response.fetch_task_queue_statistics(
            workspace_sid,
            task_queue_sid,
            end_date=end_date,
            minutes=minutes,
    ...
    @property
    def with_raw_response(self) -> TaskrouterV1TaskQueueStatisticsWithRawResponse:
        return self._with_raw_response


class AsyncTaskrouterV1TaskQueueStatistics:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncTaskrouterV1TaskQueueStatisticsWithRawResponse(client, server, auth)

    async def fetch_task_queue_statistics(
        self,
        workspace_sid: str,
        task_queue_sid: str,
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.fetch_task_queue_statistics(
                workspace_sid,
                task_queue_sid,
                end_date=end_date,
                minutes=minutes,
    ...
    @property
    def with_raw_response(self) -> AsyncTaskrouterV1TaskQueueStatisticsWithRawResponse:
        return self._with_raw_response


class TaskrouterV1TaskQueueStatisticsWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def fetch_task_queue_statistics(
        self,
        workspace_sid: str,
        task_queue_sid: str,
        *,
        ...
        split_by_wait_time: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics, RawError]:
        """Send a ``GET`` request.
        ...
        return self._client.execute(
            http_method="GET",
            url_template=self._server.default8("/v1/Workspaces/{WorkspaceSid}/TaskQueues/{TaskQueueSid}/Statistics"),
            ...
            decoder=json_decoder[TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncTaskrouterV1TaskQueueStatisticsWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def fetch_task_queue_statistics(
        self,
        workspace_sid: str,
        task_queue_sid: str,
