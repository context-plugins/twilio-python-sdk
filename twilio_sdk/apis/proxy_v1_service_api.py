...
class ProxyV1ServiceApi:
    ...
    def create_service4(
        ...
        *,
        ...
        intercept_callback_url: AnyUrl | None = None,
        out_of_session_callback_url: AnyUrl | None = None,
        ...
        return self._client.execute(
            ...
            body=form_body(
                [
                    ...
                    param[AnyUrl | None]("InterceptCallbackUrl", intercept_callback_url),
                    param[AnyUrl | None]("OutOfSessionCallbackUrl", out_of_session_callback_url),
