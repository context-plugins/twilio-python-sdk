...
class TaskrouterV1Workflow:
    ...
    def create_workflow(
        ...
        configuration: str,
        *,
        assignment_callback_url: AnyUrl | None = None,
        fallback_assignment_callback_url: AnyUrl | None = None,
        ...
        return self._client.execute(
            ...
            body=form_body(
                [
                    ...
                    param[AnyUrl | None]("AssignmentCallbackUrl", assignment_callback_url),
                    param[AnyUrl | None]("FallbackAssignmentCallbackUrl", fallback_assignment_callback_url),
