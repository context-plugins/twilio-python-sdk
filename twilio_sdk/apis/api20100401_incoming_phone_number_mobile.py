...
from ..models.api_v2010_account_incoming_phone_number_incoming_phone_number_mobile import (
    ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile,
)
from ..models.enums.incoming_phone_number_mobile_enum_emergency_status import (
    IncomingPhoneNumberMobileEnumEmergencyStatusOrStr,
)
from ..models.enums.incoming_phone_number_mobile_enum_voice_receive_mode import (
...
from ..models.list_incoming_phone_number_mobile_response import ListIncomingPhoneNumberMobileResponse
from ..server.server import Server


class Api20100401IncomingPhoneNumberMobile:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = Api20100401IncomingPhoneNumberMobileWithRawResponse(client, server, auth)
    ...
    def create_incoming_phone_number_mobile(
        ...
        *,
        ...
        emergency_status: IncomingPhoneNumberMobileEnumEmergencyStatusOrStr | None = None,
        emergency_address_sid: str | None = None,
        trunk_sid: str | None = None,
        voice_receive_mode: IncomingPhoneNumberMobileEnumVoiceReceiveModeOrStr | None = None,
        ...
        Args:
            ...
            friendly_name: A descriptive string that you created to describe the new phone number. It can be up to 64
                characters long. By default, the is a formatted version of the phone number.
        ...
        return self._with_raw_response.create_incoming_phone_number_mobile(
            account_sid,
            phone_number,
    ...
    def list_incoming_phone_number_mobile(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return self._with_raw_response.list_incoming_phone_number_mobile(
            account_sid,
            beta=beta,
            friendly_name=friendly_name,
    ...
    @property
    def with_raw_response(self) -> Api20100401IncomingPhoneNumberMobileWithRawResponse:
        return self._with_raw_response


class AsyncApi20100401IncomingPhoneNumberMobile:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncApi20100401IncomingPhoneNumberMobileWithRawResponse(client, server, auth)

    async def create_incoming_phone_number_mobile(
        self,
        account_sid: str,
        phone_number: str,
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.create_incoming_phone_number_mobile(
                account_sid,
                phone_number,
                api_version=api_version,
                friendly_name=friendly_name,
    ...
    async def list_incoming_phone_number_mobile(
        self,
        account_sid: str,
        *,
        beta: bool | None = None,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.list_incoming_phone_number_mobile(
                account_sid,
                beta=beta,
                friendly_name=friendly_name,
                phone_number=phone_number,
    ...
    @property
    def with_raw_response(self) -> AsyncApi20100401IncomingPhoneNumberMobileWithRawResponse:
        return self._with_raw_response


class Api20100401IncomingPhoneNumberMobileWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def create_incoming_phone_number_mobile(
        self,
        account_sid: str,
        phone_number: str,
        *,
        ...
        bundle_sid: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile, RawError]:
        """Incoming mobile phone numbers on a Twilio account/project
        ...
        return self._client.execute(
            http_method="POST",
            url_template=self._server.default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json"),
            ...
            body=form_body(
                [
                    ...
                    param[IncomingPhoneNumberMobileEnumEmergencyStatusOrStr | None](
                        "EmergencyStatus", emergency_status
                    ),
                    param[str | None]("EmergencyAddressSid", emergency_address_sid),
                    param[str | None]("TrunkSid", trunk_sid),
                    param[IncomingPhoneNumberMobileEnumVoiceReceiveModeOrStr | None](
            ...
            decoder=json_decoder[ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile],
    ...
    def list_incoming_phone_number_mobile(
        ...
        *,
        ...
        page_token: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ListIncomingPhoneNumberMobileResponse, RawError]:
        """Incoming mobile phone numbers on a Twilio account/project
        ...
        return self._client.execute(
            ...
            auth_scheme=self._auth.account_sid_auth_token,
            decoder=json_decoder[ListIncomingPhoneNumberMobileResponse],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncApi20100401IncomingPhoneNumberMobileWithRawResponse(
