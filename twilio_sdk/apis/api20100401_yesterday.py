...
from ..models.list_usage_record_yesterday_response import ListUsageRecordYesterdayResponse
from ..server.server import Server


class Api20100401Yesterday:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = Api20100401YesterdayWithRawResponse(client, server, auth)
    ...
    def list_usage_record_yesterday(
        ...
        *,
        ...
        return self._with_raw_response.list_usage_record_yesterday(
            account_sid,
            category=category,
    ...
    @property
    def with_raw_response(self) -> Api20100401YesterdayWithRawResponse:
        return self._with_raw_response


class AsyncApi20100401Yesterday:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncApi20100401YesterdayWithRawResponse(client, server, auth)

    async def list_usage_record_yesterday(
        self,
        account_sid: str,
        *,
        category: str | None = None,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.list_usage_record_yesterday(
                account_sid,
                category=category,
                start_date=start_date,
                end_date=end_date,
    ...
    @property
    def with_raw_response(self) -> AsyncApi20100401YesterdayWithRawResponse:
        return self._with_raw_response


class Api20100401YesterdayWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def list_usage_record_yesterday(
        self,
        account_sid: str,
        *,
        ...
        page_token: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ListUsageRecordYesterdayResponse, RawError]:
        """Usage records for yesterday
        ...
        return self._client.execute(
            http_method="GET",
            url_template=self._server.default("/2010-04-01/Accounts/{AccountSid}/Usage/Records/Yesterday.json"),
            ...
            decoder=json_decoder[ListUsageRecordYesterdayResponse],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncApi20100401YesterdayWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def list_usage_record_yesterday(
        self,
        account_sid: str,
        *,
