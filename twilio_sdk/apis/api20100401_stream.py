...
from ..models.api_v2010_account_call_stream import ApiV2010AccountCallStream
from ..models.enums.status_callback_method19 import StatusCallbackMethod19OrStr
from ..models.enums.stream_enum_track import StreamEnumTrackOrStr
from ..models.enums.stream_enum_update_status import StreamEnumUpdateStatusOrStr
from ..server.server import Server


class Api20100401Stream:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = Api20100401StreamWithRawResponse(client, server, auth)
    ...
    def create_stream(
        ...
        *,
        name: str | None = None,
        track: StreamEnumTrackOrStr | None = None,
        status_callback: AnyUrl | None = None,
        status_callback_method: StatusCallbackMethod19OrStr | None = None,
        ...
        Args:
            account_sid: The SID of the `Account <https://www.twilio.com/docs/iam/api/account>`__ that created this
                Stream resource.
            call_sid: The SID of the `Call <https://www.twilio.com/docs/voice/api/call-resource>`__ the Stream resource
                is associated with.
            url: Relative or absolute URL where WebSocket connection will be established.
            name: The user-specified name of this Stream, if one was given when the Stream was created. This can be used
                to stop the Stream.
            track: The tracks to be included in the Stream. Possible values are ``inbound_track``, ``outbound_track``,
                ``both_tracks``. Default value is ``inbound_track``.
            status_callback: Absolute URL to which Twilio sends status callback HTTP requests.
            status_callback_method: The HTTP method Twilio uses when sending ``status_callback`` requests. Possible
                values are ``GET`` and ``POST``. Default is ``POST``.
        ...
        return self._with_raw_response.create_stream(
            account_sid,
            call_sid,
            url,
            name=name,
    ...
    def update_stream(
        ...
        call_sid: str,
        sid: str,
        status: StreamEnumUpdateStatusOrStr,
        *,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiV2010AccountCallStream:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return self._with_raw_response.update_stream(
            account_sid, call_sid, sid, status, request_options=request_options
        ).unwrap()

    @property
    def with_raw_response(self) -> Api20100401StreamWithRawResponse:
        return self._with_raw_response


class AsyncApi20100401Stream:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncApi20100401StreamWithRawResponse(client, server, auth)
    ...
    async def create_stream(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.create_stream(
                account_sid,
                call_sid,
                url,
                name=name,
    ...
    async def update_stream(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.update_stream(
                account_sid, call_sid, sid, status, request_options=request_options
            )
        ).unwrap()

    @property
    def with_raw_response(self) -> AsyncApi20100401StreamWithRawResponse:
        return self._with_raw_response


class Api20100401StreamWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def create_stream(
        self,
        account_sid: str,
        call_sid: str,
        ...
        *,
        ...
        parameter99_value: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ApiV2010AccountCallStream, RawError]:
        """Create a Stream
        ...
        return self._client.execute(
            http_method="POST",
            url_template=self._server.default("/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Streams.json"),
            path_params=[param[str]("AccountSid", account_sid), param[str]("CallSid", call_sid)],
            body=form_body(
                [
                    param[AnyUrl]("Url", url),
                    param[str | None]("Name", name),
                    param[StreamEnumTrackOrStr | None]("Track", track),
                    param[AnyUrl | None]("StatusCallback", status_callback),
                    param[StatusCallbackMethod19OrStr | None]("StatusCallbackMethod", status_callback_method),
            ...
            decoder=json_decoder[ApiV2010AccountCallStream],
    ...
    def update_stream(
        ...
        *,
        ...
        return self._client.execute(
            http_method="POST",
            url_template=self._server.default("/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Streams/{Sid}.json"),
            path_params=[
                param[str]("AccountSid", account_sid), param[str]("CallSid", call_sid), param[str]("Sid", sid)
            ],
            body=form_body([param[StreamEnumUpdateStatusOrStr]("Status", status)]),
            auth_scheme=self._auth.account_sid_auth_token,
            decoder=json_decoder[ApiV2010AccountCallStream],
            error_mapper=raw_error_response,
            request_options=request_options,
...
class AsyncApi20100401StreamWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def create_stream(
        self,
        account_sid: str,
        call_sid: str,
