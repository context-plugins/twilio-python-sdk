...
from ..models.api_v2010_account_incoming_phone_number_incoming_phone_number_toll_free import (
    ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree,
)
from ..models.enums.incoming_phone_number_toll_free_enum_emergency_status import (
    IncomingPhoneNumberTollFreeEnumEmergencyStatusOrStr,
)
from ..models.enums.incoming_phone_number_toll_free_enum_voice_receive_mode import (
...
from ..models.list_incoming_phone_number_toll_free_response import ListIncomingPhoneNumberTollFreeResponse
from ..server.server import Server


class Api20100401IncomingPhoneNumberTollFree:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = Api20100401IncomingPhoneNumberTollFreeWithRawResponse(client, server, auth)
    ...
    def create_incoming_phone_number_toll_free(
        ...
        *,
        ...
        emergency_status: IncomingPhoneNumberTollFreeEnumEmergencyStatusOrStr | None = None,
        emergency_address_sid: str | None = None,
        trunk_sid: str | None = None,
        voice_receive_mode: IncomingPhoneNumberTollFreeEnumVoiceReceiveModeOrStr | None = None,
        ...
        Args:
            ...
            sms_application_sid: The SID of the application that should handle SMS messages sent to the new phone
                number. If an ``sms_application_sid`` is present, we ignore all ``sms_*_url`` values and use those of
                the application.
            ...
            voice_application_sid: The SID of the application we should use to handle calls to the new phone number. If
                a ``voice_application_sid`` is present, we ignore all of the voice urls and use those set on the
        ...
        return self._with_raw_response.create_incoming_phone_number_toll_free(
            account_sid,
            phone_number,
    ...
    def list_incoming_phone_number_toll_free(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return self._with_raw_response.list_incoming_phone_number_toll_free(
            account_sid,
            beta=beta,
            friendly_name=friendly_name,
    ...
    @property
    def with_raw_response(self) -> Api20100401IncomingPhoneNumberTollFreeWithRawResponse:
        return self._with_raw_response


class AsyncApi20100401IncomingPhoneNumberTollFree:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncApi20100401IncomingPhoneNumberTollFreeWithRawResponse(client, server, auth)

    async def create_incoming_phone_number_toll_free(
        self,
        account_sid: str,
        phone_number: str,
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.create_incoming_phone_number_toll_free(
                account_sid,
                phone_number,
                api_version=api_version,
                friendly_name=friendly_name,
    ...
    async def list_incoming_phone_number_toll_free(
        self,
        account_sid: str,
        *,
        beta: bool | None = None,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.list_incoming_phone_number_toll_free(
                account_sid,
                beta=beta,
                friendly_name=friendly_name,
                phone_number=phone_number,
    ...
    @property
    def with_raw_response(self) -> AsyncApi20100401IncomingPhoneNumberTollFreeWithRawResponse:
        return self._with_raw_response


class Api20100401IncomingPhoneNumberTollFreeWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def create_incoming_phone_number_toll_free(
        self,
        account_sid: str,
        phone_number: str,
        *,
        ...
        bundle_sid: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree, RawError]:
        """Incoming toll free phone numbers on a Twilio account/project
        ...
        return self._client.execute(
            http_method="POST",
            url_template=self._server.default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json"),
            ...
            body=form_body(
                [
                    ...
                    param[IncomingPhoneNumberTollFreeEnumEmergencyStatusOrStr | None](
                        "EmergencyStatus", emergency_status
                    ),
                    param[str | None]("EmergencyAddressSid", emergency_address_sid),
                    param[str | None]("TrunkSid", trunk_sid),
                    param[IncomingPhoneNumberTollFreeEnumVoiceReceiveModeOrStr | None](
            ...
            decoder=json_decoder[ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree],
    ...
    def list_incoming_phone_number_toll_free(
        ...
        *,
        ...
        page_token: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ListIncomingPhoneNumberTollFreeResponse, RawError]:
        """Incoming toll free phone numbers on a Twilio account/project
        ...
        return self._client.execute(
            ...
            auth_scheme=self._auth.account_sid_auth_token,
            decoder=json_decoder[ListIncomingPhoneNumberTollFreeResponse],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncApi20100401IncomingPhoneNumberTollFreeWithRawResponse(
