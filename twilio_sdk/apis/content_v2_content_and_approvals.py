...
class ContentV2ContentAndApprovals:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = ContentV2ContentAndApprovalsWithRawResponse(client, server, auth)

    def list_content_and_approvals2(
        self,
        *,
        ...
        return self._with_raw_response.list_content_and_approvals2(
            page_size=page_size,
            page=page,
    ...
    @property
    def with_raw_response(self) -> ContentV2ContentAndApprovalsWithRawResponse:
        return self._with_raw_response


class AsyncContentV2ContentAndApprovals:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncContentV2ContentAndApprovalsWithRawResponse(client, server, auth)

    async def list_content_and_approvals2(
        self,
        *,
        page_size: int | None = None,
        page: int | None = None,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.list_content_and_approvals2(
                page_size=page_size,
                page=page,
                page_token=page_token,
                sort_by_date=sort_by_date,
    ...
    @property
    def with_raw_response(self) -> AsyncContentV2ContentAndApprovalsWithRawResponse:
        return self._with_raw_response


class ContentV2ContentAndApprovalsWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def list_content_and_approvals2(
        self,
        *,
        page_size: int | None = None,
        ...
        return self._client.execute(
            http_method="GET",
            url_template=self._server.default2("/v2/ContentAndApprovals"),
            query_params=[
...
class AsyncContentV2ContentAndApprovalsWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def list_content_and_approvals2(
        self,
        *,
        page_size: int | None = None,
