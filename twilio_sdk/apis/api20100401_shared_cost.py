...
from ..models.list_available_phone_number_shared_cost_response import ListAvailablePhoneNumberSharedCostResponse
from ..server.server import Server


class Api20100401SharedCost:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = Api20100401SharedCostWithRawResponse(client, server, auth)
    ...
    def list_available_phone_number_shared_cost(
        ...
        *,
        ...
        return self._with_raw_response.list_available_phone_number_shared_cost(
            account_sid,
            country_code,
            area_code=area_code,
            contains=contains,
    ...
    @property
    def with_raw_response(self) -> Api20100401SharedCostWithRawResponse:
        return self._with_raw_response


class AsyncApi20100401SharedCost:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncApi20100401SharedCostWithRawResponse(client, server, auth)

    async def list_available_phone_number_shared_cost(
        self,
        account_sid: str,
        country_code: str,
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.list_available_phone_number_shared_cost(
                account_sid,
                country_code,
                area_code=area_code,
                contains=contains,
    ...
    @property
    def with_raw_response(self) -> AsyncApi20100401SharedCostWithRawResponse:
        return self._with_raw_response


class Api20100401SharedCostWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def list_available_phone_number_shared_cost(
        self,
        account_sid: str,
        country_code: str,
        *,
        ...
        page_token: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ListAvailablePhoneNumberSharedCostResponse, RawError]:
        """Available shared cost numbers
        ...
        return self._client.execute(
            ...
            decoder=json_decoder[ListAvailablePhoneNumberSharedCostResponse],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncApi20100401SharedCostWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def list_available_phone_number_shared_cost(
        self,
        account_sid: str,
        country_code: str,
