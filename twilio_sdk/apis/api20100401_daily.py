...
from ..models.list_usage_record_daily_response import ListUsageRecordDailyResponse
from ..server.server import Server


class Api20100401Daily:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = Api20100401DailyWithRawResponse(client, server, auth)
    ...
    def list_usage_record_daily(
        ...
        *,
        ...
        return self._with_raw_response.list_usage_record_daily(
            account_sid,
            category=category,
    ...
    @property
    def with_raw_response(self) -> Api20100401DailyWithRawResponse:
        return self._with_raw_response


class AsyncApi20100401Daily:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncApi20100401DailyWithRawResponse(client, server, auth)

    async def list_usage_record_daily(
        self,
        account_sid: str,
        *,
        category: str | None = None,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.list_usage_record_daily(
                account_sid,
                category=category,
                start_date=start_date,
                end_date=end_date,
    ...
    @property
    def with_raw_response(self) -> AsyncApi20100401DailyWithRawResponse:
        return self._with_raw_response


class Api20100401DailyWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def list_usage_record_daily(
        self,
        account_sid: str,
        *,
        ...
        page_token: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ListUsageRecordDailyResponse, RawError]:
        """Usage records summarized by day
        ...
        return self._client.execute(
            http_method="GET",
            url_template=self._server.default("/2010-04-01/Accounts/{AccountSid}/Usage/Records/Daily.json"),
            ...
            decoder=json_decoder[ListUsageRecordDailyResponse],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncApi20100401DailyWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def list_usage_record_daily(
        self,
        account_sid: str,
        *,
