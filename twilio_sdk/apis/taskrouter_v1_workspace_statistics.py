...
from ..models.taskrouter_v1_workspace_workspace_statistics import TaskrouterV1WorkspaceWorkspaceStatistics
from ..server.server import Server


class TaskrouterV1WorkspaceStatistics:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = TaskrouterV1WorkspaceStatisticsWithRawResponse(client, server, auth)
        ...
        *,
        ...
        Args:
            ...
            split_by_wait_time: A comma separated list of values that describes the thresholds, in seconds, to calculate
                ...
                seconds. This can be used to show short abandoned Tasks or Tasks that failed to meet an SLA.
        ...
        return self._with_raw_response.fetch_workspace_statistics(
            workspace_sid,
            minutes=minutes,
    ...
    @property
    def with_raw_response(self) -> TaskrouterV1WorkspaceStatisticsWithRawResponse:
        return self._with_raw_response


class AsyncTaskrouterV1WorkspaceStatistics:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncTaskrouterV1WorkspaceStatisticsWithRawResponse(client, server, auth)

    async def fetch_workspace_statistics(
        self,
        workspace_sid: str,
        *,
        minutes: int | None = None,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.fetch_workspace_statistics(
                workspace_sid,
                minutes=minutes,
                start_date=start_date,
                end_date=end_date,
    ...
    @property
    def with_raw_response(self) -> AsyncTaskrouterV1WorkspaceStatisticsWithRawResponse:
        return self._with_raw_response


class TaskrouterV1WorkspaceStatisticsWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def fetch_workspace_statistics(
        self,
        workspace_sid: str,
        *,
        ...
        split_by_wait_time: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[TaskrouterV1WorkspaceWorkspaceStatistics, RawError]:
        """Send a ``GET`` request.
        ...
        return self._client.execute(
            http_method="GET",
            url_template=self._server.default8("/v1/Workspaces/{WorkspaceSid}/Statistics"),
            ...
            decoder=json_decoder[TaskrouterV1WorkspaceWorkspaceStatistics],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncTaskrouterV1WorkspaceStatisticsWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def fetch_workspace_statistics(
        self,
        workspace_sid: str,
        *,
