...
class Api20100401Application:
    ...
    def create_application(
        ...
        *,
        ...
        sms_status_callback: AnyUrl | None = None,
        message_status_callback: AnyUrl | None = None,
        ...
        return self._client.execute(
            ...
            body=form_body(
                [
                    ...
                    param[AnyUrl | None]("SmsStatusCallback", sms_status_callback),
                    param[AnyUrl | None]("MessageStatusCallback", message_status_callback),
