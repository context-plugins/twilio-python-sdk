...
class Api20100401ConnectApp:
    ...
    def update_connect_app(
        ...
        sid: str,
        *,
        authorize_redirect_url: AnyUrl | None = None,
        company_name: str | None = None,
        deauthorize_callback_method: DeauthorizeCallbackMethod1OrStr | None = None,
        deauthorize_callback_url: AnyUrl | None = None,
    ...
    def update_connect_app(
        ...
        *,
        ...
        return self._client.execute(
            ...
            body=form_body(
                [
                    param[AnyUrl | None]("AuthorizeRedirectUrl", authorize_redirect_url),
                    ...
                    param[AnyUrl | None]("DeauthorizeCallbackUrl", deauthorize_callback_url),
                    param[str | None]("Description", description),
                    param[str | None]("FriendlyName", friendly_name),
                    param[AnyUrl | None]("HomepageUrl", homepage_url),
