...
from ..models.list_available_phone_number_mobile_response import ListAvailablePhoneNumberMobileResponse
from ..server.server import Server


class Api20100401Mobile:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = Api20100401MobileWithRawResponse(client, server, auth)
    ...
    def list_available_phone_number_mobile(
        ...
        *,
        ...
        return self._with_raw_response.list_available_phone_number_mobile(
            account_sid,
            country_code,
            area_code=area_code,
            contains=contains,
    ...
    @property
    def with_raw_response(self) -> Api20100401MobileWithRawResponse:
        return self._with_raw_response


class AsyncApi20100401Mobile:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncApi20100401MobileWithRawResponse(client, server, auth)

    async def list_available_phone_number_mobile(
        self,
        account_sid: str,
        country_code: str,
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.list_available_phone_number_mobile(
                account_sid,
                country_code,
                area_code=area_code,
                contains=contains,
    ...
    @property
    def with_raw_response(self) -> AsyncApi20100401MobileWithRawResponse:
        return self._with_raw_response


class Api20100401MobileWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def list_available_phone_number_mobile(
        self,
        account_sid: str,
        country_code: str,
        *,
        ...
        page_token: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ListAvailablePhoneNumberMobileResponse, RawError]:
        """Available mobile phone numbers
        ...
        return self._client.execute(
            ...
            decoder=json_decoder[ListAvailablePhoneNumberMobileResponse],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncApi20100401MobileWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def list_available_phone_number_mobile(
        self,
        account_sid: str,
        country_code: str,
