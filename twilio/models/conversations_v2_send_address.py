...
from .enums.channel21 import Channel21OrStr


class ConversationsV2SendAddress(SdkBaseModel):
    address: str
    ...
    """Optional Participant ID. If omitted, the system will resolve or create the participant based on address and
    channel."""


class ConversationsV2SendAddressDict(TypedDict):
    address: str
    channel: Channel21OrStr
