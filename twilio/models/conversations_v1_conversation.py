...
from .enums.conversation_enum_state import ConversationEnumStateOrStr


class ConversationsV1Conversation(SdkBaseModel):
    ...
    state: Optional[ConversationEnumStateOrStr] = UNSET
...
class ConversationsV1ConversationDict(TypedDict):
    ...
    state: NotRequired[ConversationEnumStateOrStr]
