...
class ListSipDomainResponse(SdkBaseModel):
    ...
    domains: Optional[list[ApiV2010AccountSipSipDomain]] = UNSET


class ListSipDomainResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    domains: NotRequired[list[ApiV2010AccountSipSipDomain | ApiV2010AccountSipSipDomainDict]]
