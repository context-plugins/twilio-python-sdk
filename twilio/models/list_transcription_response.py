...
class ListTranscriptionResponse(SdkBaseModel):
    ...
    transcriptions: Optional[list[ApiV2010AccountTranscription]] = UNSET


class ListTranscriptionResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    transcriptions: NotRequired[list[ApiV2010AccountTranscription | ApiV2010AccountTranscriptionDict]]
