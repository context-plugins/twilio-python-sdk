...
class ListSipAuthCallsIpAccessControlListMappingResponse(SdkBaseModel):
    ...
    contents: Optional[list[SipAuthCallsIpAccessControlListMapping]] = UNSET


class ListSipAuthCallsIpAccessControlListMappingResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    contents: NotRequired[list[SipAuthCallsIpAccessControlListMapping | SipAuthCallsIpAccessControlListMappingDict]]
