...
class ListParticipantResponse(SdkBaseModel):
    ...
    participants: Optional[list[ApiV2010AccountConferenceParticipant]] = UNSET


class ListParticipantResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    participants: NotRequired[list[ApiV2010AccountConferenceParticipant | ApiV2010AccountConferenceParticipantDict]]
