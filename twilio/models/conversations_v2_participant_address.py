...
from .enums.channel12 import Channel12OrStr


class ConversationsV2ParticipantAddress(SdkBaseModel):
    address: str
...
class ConversationsV2ParticipantAddressDict(TypedDict):
    address: str
    channel: Channel12OrStr
