...
from .enums.supporting_document_enum_status1 import SupportingDocumentEnumStatus1OrStr


class TrusthubV1SupportingDocument(SdkBaseModel):
    ...
    status: Optional[SupportingDocumentEnumStatus1OrStr] = UNSET
...
class TrusthubV1SupportingDocumentDict(TypedDict):
    sid: NotRequired[str | None]
    account_sid: NotRequired[str | None]
    friendly_name: NotRequired[str | None]
    mime_type: NotRequired[str | None]
    status: NotRequired[SupportingDocumentEnumStatus1OrStr]
