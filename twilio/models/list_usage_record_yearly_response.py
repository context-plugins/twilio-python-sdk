...
class ListUsageRecordYearlyResponse(SdkBaseModel):
    ...
    usage_records: Optional[list[ApiV2010AccountUsageUsageRecordUsageRecordYearly]] = UNSET


class ListUsageRecordYearlyResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    usage_records: NotRequired[
        list[ApiV2010AccountUsageUsageRecordUsageRecordYearly | ApiV2010AccountUsageUsageRecordUsageRecordYearlyDict]
    ]
