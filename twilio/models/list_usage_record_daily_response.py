...
class ListUsageRecordDailyResponse(SdkBaseModel):
    ...
    usage_records: Optional[list[ApiV2010AccountUsageUsageRecordUsageRecordDaily]] = UNSET


class ListUsageRecordDailyResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    usage_records: NotRequired[
        list[ApiV2010AccountUsageUsageRecordUsageRecordDaily | ApiV2010AccountUsageUsageRecordUsageRecordDailyDict]
    ]
