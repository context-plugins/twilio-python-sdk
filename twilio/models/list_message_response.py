...
class ListMessageResponse(SdkBaseModel):
    ...
    messages: Optional[list[ApiV2010AccountMessage]] = UNSET


class ListMessageResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    uri: NotRequired[str]
    messages: NotRequired[list[ApiV2010AccountMessage | ApiV2010AccountMessageDict]]
