...
from .enums.transcription_enum_status import TranscriptionEnumStatusOrStr


class ApiV2010AccountTranscription(SdkBaseModel):
    ...
    status: Optional[TranscriptionEnumStatusOrStr] = UNSET
...
class ApiV2010AccountTranscriptionDict(TypedDict):
    ...
    status: NotRequired[TranscriptionEnumStatusOrStr]
