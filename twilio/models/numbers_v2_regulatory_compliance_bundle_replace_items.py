...
from .enums.replace_items_enum_status import ReplaceItemsEnumStatusOrStr


class NumbersV2RegulatoryComplianceBundleReplaceItems(SdkBaseModel):
    ...
    status: Optional[ReplaceItemsEnumStatusOrStr] = UNSET
...
class NumbersV2RegulatoryComplianceBundleReplaceItemsDict(TypedDict):
    sid: NotRequired[str | None]
    account_sid: NotRequired[str | None]
    regulation_sid: NotRequired[str | None]
    friendly_name: NotRequired[str | None]
    status: NotRequired[ReplaceItemsEnumStatusOrStr]
