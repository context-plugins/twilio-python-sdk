...
class ListUsageRecordLastMonthResponse(SdkBaseModel):
    ...
    usage_records: Optional[list[ApiV2010AccountUsageUsageRecordUsageRecordLastMonth]] = UNSET


class ListUsageRecordLastMonthResponseDict(TypedDict):
    end: NotRequired[int]
