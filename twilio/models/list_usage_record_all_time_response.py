...
class ListUsageRecordAllTimeResponse(SdkBaseModel):
    ...
    usage_records: Optional[list[ApiV2010AccountUsageUsageRecordUsageRecordAllTime]] = UNSET


class ListUsageRecordAllTimeResponseDict(TypedDict):
    end: NotRequired[int]
    ...
    usage_records: NotRequired[
        list[ApiV2010AccountUsageUsageRecordUsageRecordAllTime | ApiV2010AccountUsageUsageRecordUsageRecordAllTimeDict]
    ]
