...
from .enums.incoming_phone_number_mobile_enum_address_requirement import (
    IncomingPhoneNumberMobileEnumAddressRequirementOrStr,
)
from .enums.incoming_phone_number_mobile_enum_emergency_address_status import (
    IncomingPhoneNumberMobileEnumEmergencyAddressStatusOrStr,
)
from .enums.incoming_phone_number_mobile_enum_emergency_status import IncomingPhoneNumberMobileEnumEmergencyStatusOrStr
from .enums.incoming_phone_number_mobile_enum_voice_receive_mode import (
...
class ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile(SdkBaseModel):
    ...
    address_requirements: Optional[IncomingPhoneNumberMobileEnumAddressRequirementOrStr] = UNSET
    ...
    voice_receive_mode: Optional[IncomingPhoneNumberMobileEnumVoiceReceiveModeOrStr] = UNSET
    ...
    emergency_status: Optional[IncomingPhoneNumberMobileEnumEmergencyStatusOrStr] = UNSET
    ...
    emergency_address_status: Optional[IncomingPhoneNumberMobileEnumEmergencyAddressStatusOrStr] = UNSET
...
class ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobileDict(TypedDict):
    account_sid: NotRequired[str | None]
    address_sid: NotRequired[str | None]
    address_requirements: NotRequired[IncomingPhoneNumberMobileEnumAddressRequirementOrStr]
    ...
    voice_receive_mode: NotRequired[IncomingPhoneNumberMobileEnumVoiceReceiveModeOrStr]
    ...
    emergency_status: NotRequired[IncomingPhoneNumberMobileEnumEmergencyStatusOrStr]
    emergency_address_sid: NotRequired[str | None]
    emergency_address_status: NotRequired[IncomingPhoneNumberMobileEnumEmergencyAddressStatusOrStr]
