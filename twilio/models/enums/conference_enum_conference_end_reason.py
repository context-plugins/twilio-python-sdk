...
class ConferenceEnumConferenceEndReason(str, Enum):
...
ConferenceEnumConferenceEndReasonOrStr: TypeAlias = Annotated[
    ConferenceEnumConferenceEndReason | str, open_enum_validator(ConferenceEnumConferenceEndReason)
]
