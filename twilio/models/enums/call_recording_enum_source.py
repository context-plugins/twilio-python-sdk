...
class CallRecordingEnumSource(str, Enum):
...
CallRecordingEnumSourceOrStr: TypeAlias = Annotated[
    CallRecordingEnumSource | str, open_enum_validator(CallRecordingEnumSource)
]
