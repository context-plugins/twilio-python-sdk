...
class ConversationsV1ServiceServiceConversationServiceConversationMessage(SdkBaseModel):
...
class ConversationsV1ServiceServiceConversationServiceConversationMessageDict(TypedDict):
