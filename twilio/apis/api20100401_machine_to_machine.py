...
from ..models.list_available_phone_number_machine_to_machine_response import (
    ListAvailablePhoneNumberMachineToMachineResponse,
)
from ..server.server import Server


class Api20100401MachineToMachine:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = Api20100401MachineToMachineWithRawResponse(client, server, auth)
    ...
    def list_available_phone_number_machine_to_machine(
        ...
        *,
        ...
        return self._with_raw_response.list_available_phone_number_machine_to_machine(
            account_sid,
            country_code,
            area_code=area_code,
            contains=contains,
    ...
    @property
    def with_raw_response(self) -> Api20100401MachineToMachineWithRawResponse:
        return self._with_raw_response


class AsyncApi20100401MachineToMachine:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncApi20100401MachineToMachineWithRawResponse(client, server, auth)

    async def list_available_phone_number_machine_to_machine(
        self,
        account_sid: str,
        country_code: str,
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.list_available_phone_number_machine_to_machine(
                account_sid,
                country_code,
                area_code=area_code,
                contains=contains,
    ...
    @property
    def with_raw_response(self) -> AsyncApi20100401MachineToMachineWithRawResponse:
        return self._with_raw_response


class Api20100401MachineToMachineWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def list_available_phone_number_machine_to_machine(
        self,
        account_sid: str,
        country_code: str,
        *,
        ...
        page_token: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[ListAvailablePhoneNumberMachineToMachineResponse, RawError]:
        """Available machine-to-machine phone numbers
        ...
        return self._client.execute(
            ...
            decoder=json_decoder[ListAvailablePhoneNumberMachineToMachineResponse],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncApi20100401MachineToMachineWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def list_available_phone_number_machine_to_machine(
        self,
        account_sid: str,
        country_code: str,
