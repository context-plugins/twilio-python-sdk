...
from ..models.taskrouter_v1_workspace_workflow_workflow_statistics import (
    TaskrouterV1WorkspaceWorkflowWorkflowStatistics,
)
from ..server.server import Server


class TaskrouterV1WorkflowStatistics:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = TaskrouterV1WorkflowStatisticsWithRawResponse(client, server, auth)
    ...
    def fetch_workflow_statistics(
        ...
        *,
        ...
        return self._with_raw_response.fetch_workflow_statistics(
            workspace_sid,
            workflow_sid,
            minutes=minutes,
    ...
    @property
    def with_raw_response(self) -> TaskrouterV1WorkflowStatisticsWithRawResponse:
        return self._with_raw_response


class AsyncTaskrouterV1WorkflowStatistics:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncTaskrouterV1WorkflowStatisticsWithRawResponse(client, server, auth)

    async def fetch_workflow_statistics(
        self,
        workspace_sid: str,
        workflow_sid: str,
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.fetch_workflow_statistics(
                workspace_sid,
                workflow_sid,
                minutes=minutes,
                start_date=start_date,
    ...
    @property
    def with_raw_response(self) -> AsyncTaskrouterV1WorkflowStatisticsWithRawResponse:
        return self._with_raw_response


class TaskrouterV1WorkflowStatisticsWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def fetch_workflow_statistics(
        self,
        workspace_sid: str,
        workflow_sid: str,
        *,
        ...
        split_by_wait_time: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[TaskrouterV1WorkspaceWorkflowWorkflowStatistics, RawError]:
        """Send a ``GET`` request.
        ...
        return self._client.execute(
            http_method="GET",
            url_template=self._server.default8("/v1/Workspaces/{WorkspaceSid}/Workflows/{WorkflowSid}/Statistics"),
            ...
            decoder=json_decoder[TaskrouterV1WorkspaceWorkflowWorkflowStatistics],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncTaskrouterV1WorkflowStatisticsWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def fetch_workflow_statistics(
        self,
        workspace_sid: str,
        workflow_sid: str,
