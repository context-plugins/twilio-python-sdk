...
from ..models.taskrouter_v1_workspace_workspace_cumulative_statistics import (
    TaskrouterV1WorkspaceWorkspaceCumulativeStatistics,
)
from ..server.server import Server


class TaskrouterV1WorkspaceCumulativeStatistics:
    def __init__(self, client: RawClient, server: Server, auth: AuthSchemes) -> None:
        self._with_raw_response = TaskrouterV1WorkspaceCumulativeStatisticsWithRawResponse(client, server, auth)
    ...
    def fetch_workspace_cumulative_statistics(
        ...
        *,
        ...
        return self._with_raw_response.fetch_workspace_cumulative_statistics(
            workspace_sid,
            end_date=end_date,
            minutes=minutes,
    ...
    @property
    def with_raw_response(self) -> TaskrouterV1WorkspaceCumulativeStatisticsWithRawResponse:
        return self._with_raw_response


class AsyncTaskrouterV1WorkspaceCumulativeStatistics:
    def __init__(self, client: AsyncRawClient, server: Server, auth: AsyncAuthSchemes) -> None:
        self._with_raw_response = AsyncTaskrouterV1WorkspaceCumulativeStatisticsWithRawResponse(client, server, auth)

    async def fetch_workspace_cumulative_statistics(
        self,
        workspace_sid: str,
        *,
        end_date: RFC3339DateTime | None = None,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self._with_raw_response.fetch_workspace_cumulative_statistics(
                workspace_sid,
                end_date=end_date,
                minutes=minutes,
                start_date=start_date,
    ...
    @property
    def with_raw_response(self) -> AsyncTaskrouterV1WorkspaceCumulativeStatisticsWithRawResponse:
        return self._with_raw_response


class TaskrouterV1WorkspaceCumulativeStatisticsWithRawResponse(SecuredRawResponse[RawClient, Server, AuthSchemes]):
    def fetch_workspace_cumulative_statistics(
        self,
        workspace_sid: str,
        *,
        ...
        split_by_wait_time: str | None = None,
        request_options: RequestOptionsOrDict | None = None,
    ) -> ApiResult[TaskrouterV1WorkspaceWorkspaceCumulativeStatistics, RawError]:
        """Send a ``GET`` request.
        ...
        return self._client.execute(
            http_method="GET",
            url_template=self._server.default8("/v1/Workspaces/{WorkspaceSid}/CumulativeStatistics"),
            ...
            decoder=json_decoder[TaskrouterV1WorkspaceWorkspaceCumulativeStatistics],
            error_mapper=raw_error_response,
            request_options=request_options,
        )


class AsyncTaskrouterV1WorkspaceCumulativeStatisticsWithRawResponse(
